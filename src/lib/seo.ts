...
export const siteConfig = {
  name: 'Envimerse',
  title: 'Envimerse - VR Entertainment Platform',
  description: 'Experience the future of entertainment in virtual reality. Join immersive VR events, concerts, and experiences with blockchain-powered ticketing.',
  url: 'https://envimerse.vercel.app',
  ogImage: '/og-image.png',
  links: {
    twitter: 'https://twitter.com/envimerse',
    github: 'https://github.com/envimerse',
...
export const defaultMetadata: Metadata = {
  ...
  icons: {
    ...
    other: [
      { rel: 'mask-icon', url: '/icon.svg', color: '#8D42EC' },
    ],
  },
